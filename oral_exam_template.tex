...
\QT{need to write down the Vlasov--Poisson equation}
...
\begin{align}
    ...
    \end{split}
\end{align}
where $N_{CG}$ is the number of basis functions in the discrete $H^1$ finite element space. Recall \eqref{eq:discrete_E_equation}, and recall that in leap-frog stepping, 
\begin{align}
    \begin{split}
        \frac{d\mathbf{x}_p}{dt} & = \frac{\mathbf{p}_p}{m_p}          \\
